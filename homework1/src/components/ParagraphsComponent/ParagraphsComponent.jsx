...
const Paragraphs = () => {
    return (
        ...
        <div className="container">
            ...
            <p className="paragrah">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Amet voluptatum libero minima blanditiis quae illo officiis obcaecati fuga quidem, aliquam temporibus est consequuntur molestias maiores mollitia ex placeat cupiditate? Esse provident facilis quisquam dolore suscipit, in repellendus blanditiis quibusdam, et commodi ipsum. Quas repellat delectus atque exercitationem recusandae aspernatur deserunt!                
            </p>
